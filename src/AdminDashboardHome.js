...
var signOutButton = document.getElementById("ASignOut");
...
window.onload = function(){
    document.getElementById("AlistOfIncompleteTasks").innerHTML = listOfIncompleteTasks;
    document.getElementById("AlistOfCompleteTasks").innerHTML = listOfCompleteTasks;
}
